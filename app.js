...
const mexabotMasterIdentity = {
    ...
    options: {
        ...
        "1_2": `📅 <strong>Cronos — Recepción & Agendamiento Inteligente:</strong><br>Elimina tiempos muertos y citas canceladas coordinando disponibilidad en tiempo real con Google Calendar o Cal.com.<br><br>💡 <strong>¿Para qué te sirve en tu negocio?</strong><br>• <em>Clínicas & Spas:</em> Permite a pacientes reservar, reagendar o cancelar sin esperas.<br>• <em>Abogados & Asesores:</em> Reserva sesiones y cobra consultas previas solo en tus bloques libres.<br>• <em>Talleres & Servicios:</em> Asigna turnos según la ruta y tiempo estimado de trabajo.<br><br>⌨️ <em>Comandos base:</em> <em>'agendar cita'</em>, <em>'cambiar horario'</em>, <em>'recordatorios'</em>.<br><br>1️⃣ <em>Ver precios y paquetes</em><br>2️⃣ <em>Ver métodos de instalación</em><br>9️⃣ <em>Volver al Menú Principal</em><br>0️⃣ <em>Hablar con un asesor</em>`,
        ...
        "4": `⏱️ <strong>Proceso de Activación Oficial & Dashboard:</strong><br><br>1. <strong>Puente Oficial:</strong> Activamos el módulo oficial <em>Clawboard</em> en <em>Microsoft PC Manager</em> (despliegue del sandbox seguro).<br>2. <strong>Dashboard Automático:</strong> PC Manager genera tu panel local de control en tu entorno on-premise.<br>3. <strong>Enlace en 10s:</strong> Vinculamos tu número escaneando el QR oficial en pantalla.<br>4. <strong>App Móvil (Opcional):</strong> Puedes monitorear desde el dashboard web, la app oficial de OpenClaw, cualquier cliente Gateway o nuestra app MexaBot Mobile.<br><br>1️⃣ <em>Ver Requisitos Técnicos & Aviso de Responsabilidad</em><br>2️⃣ <em>Iniciar Activación con un Asesor</em><br>9️⃣ <em>Volver al Menú Principal</em><br>0️⃣ <em>Hablar con un asesor humano</em>`,
